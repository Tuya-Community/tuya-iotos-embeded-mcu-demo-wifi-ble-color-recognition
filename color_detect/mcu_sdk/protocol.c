...
{
  {DPID_RED, DP_TYPE_VALUE},
  {DPID_GREEN, DP_TYPE_VALUE},
  {DPID_BLUE, DP_TYPE_VALUE},
};
...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_RED,当前红色强度); //VALUE型数据上报;
    mcu_dp_value_update(DPID_GREEN,当前绿色强度); //VALUE型数据上报;
    mcu_dp_value_update(DPID_BLUE,当前蓝色强度); //VALUE型数据上报;
